...
public class SearchOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Show All Order Details");
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, -1, -1));

        jRadioButton2.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
        jRadioButton2.setText("Show By Order ID");
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, -1, -1));

        jLabel1.setFont(new java.awt.Font("Microsoft YaHei UI", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("SEARCH");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, -1, -1));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, 170, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 470, 220));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jRadioButton1.isSelected())
        {
            ...
            sql="select * from orders where ord_id like'%"+jTextField1.getText().trim()+"%'";
        }
