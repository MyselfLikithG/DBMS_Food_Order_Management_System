...
public class DeleteOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 80, 150, 30));
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 140, 150, 30));

        jTextField3.setEnabled(false);
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 200, 150, 30));

        jTextField4.setEnabled(false);
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 260, 150, 30));

        jTextField5.setEnabled(false);
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 320, 150, 30));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\Hp\\Downloads\\MiniProject\\insertcustomer.jpg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jButton1.getText().equals("SEARCH")){
            ...
            String SQL="Select * from orders where ord_id ='"+jTextField1.getText().trim()+"' and food_id ='"+jTextField2.getText().trim()+"'";
            ...
            jButton1.setText("SEARCH");
            String SQL="Delete from orders where ord_id ='"+jTextField1.getText().trim()+"' and food_id ='"+jTextField2.getText().trim()+"'";
                try {
